...
public class Tree {
    ...
    private final ArrayList<Integer> keyroots = new ArrayList<>();
    // list of the labels of the nodes used for node comparison
    private final ArrayList<String> labels = new ArrayList<String>();

    /**
     * A tree. The following constructor handles preorder notation. E.g., f(a b(c))
     *
     * @param s tree string
    ...
    private static ArrayList<String> traverse(final Node node, final ArrayList<String> l) {
        ArrayList<String> labels = l;
    ...
    public static int ZhangShasha(String tree1, String tree2) throws IOException {
        return ZhangShasha(new Tree(tree1), new Tree(tree2));
    }
