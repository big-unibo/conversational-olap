...
public class DependencyGraph {
  ...
  public static Graph<String, DefaultEdge> getDependencies() {
    switch (DBmanager.metaDb) {
    case "covid_metadata":
      return getCovidMartDependencies();
    case "conversational":
      return getFoodMartDependencies();
    }
    throw new IllegalArgumentException("Unknown schema: " + DBmanager.metaDb);
  }
...
//    g.addEdge("product_department", "all_product");
  ...
  public static Optional<String> lca(final String s1, final String s2) {
    final NaiveLCAFinder<String, DefaultEdge> lca = new NaiveLCAFinder<String, DefaultEdge>(getDependencies());
