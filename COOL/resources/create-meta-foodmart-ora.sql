...
-- select * from "TABLE";
select * from "SYNONYM" order by 1 asc;
INSERT INTO groupbyoperator_of_measure select groupbyoperator_id, measure_id from measure, groupbyoperator;
delete from "SYNONYM" where synonym_id like '-%';
INSERT INTO "SYNONYM"(synonym_id, table_name, reference_id, term) VALUES ('-02', 'FACT',               (select fact_id from fact where lower(fact_name) = lower('sales_fact_1997')), 'sales');
INSERT INTO "SYNONYM"(synonym_id, table_name, reference_id, term) VALUES ('-03', 'LEVEL',              (select level_id from level where lower(level_name) = lower('product_category')), 'category');
INSERT INTO "SYNONYM"(synonym_id, table_name, reference_id, term) VALUES ('-04', 'LEVEL',              (select level_id from level where lower(level_name) = lower('product_subcategory')), 'subcategory');
INSERT INTO "SYNONYM"(synonym_id, table_name, reference_id, term) VALUES ('-05', 'LEVEL',              (select level_id from "LEVEL" where lower(level_name) = lower('product_family')), 'family');
INSERT INTO "SYNONYM"(synonym_id, table_name, reference_id, term) VALUES ('-06', 'LANGUAGE_PREDICATE', (select language_predicate_id from "LANGUAGE_PREDICATE" where lower(language_predicate_name) = lower('=')), 'as');
INSERT INTO "SYNONYM"(synonym_id, table_name, reference_id, term) VALUES ('-07', 'LANGUAGE_PREDICATE', (select language_predicate_id from "LANGUAGE_PREDICATE" where lower(language_predicate_name) = lower('by')), 'select');
INSERT INTO "SYNONYM"(synonym_id, table_name, reference_id, term) VALUES ('-08', 'LANGUAGE_PREDICATE', (select language_predicate_id from "LANGUAGE_PREDICATE" where lower(language_predicate_name) = lower('by')), 'get');
INSERT INTO "SYNONYM"(synonym_id, table_name, reference_id, term) VALUES ('-09', 'LANGUAGE_PREDICATE', (select language_predicate_id from "LANGUAGE_PREDICATE" where lower(language_predicate_name) = lower('by')), 'find');
INSERT INTO "SYNONYM"(synonym_id, table_name, reference_id, term) VALUES ('-10', 'LANGUAGE_PREDICATE', (select language_predicate_id from "LANGUAGE_PREDICATE" where lower(language_predicate_name) = lower('by')), 'return');
