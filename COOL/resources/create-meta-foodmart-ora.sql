...
INSERT INTO "SYNONYM"(synonym_id, table_name, reference_id, term) VALUES ('-06', 'LANGUAGE_OPERATOR',  (select language_operator_id from "LANGUAGE_OPERATOR" where lower(language_operator_name) = lower('=')), 'as');
